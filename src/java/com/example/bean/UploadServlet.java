...
public class UploadServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<html><head><title>Resultados de la carga</title></head></html>");
            ...
            for (Part part : parts) {
                ...
                try {
                    ...
                    if (contentType.startsWith("image") || contentType.startsWith("video")) {
                        ...
                        out.println("<br>Nombre: " + name);
                        out.println("<br>Título: " + title);
                        out.println("<br>Extensión: " + fileExtension);
                        mm.createMediaItem(item, part.getInputStream());
                    } else {
                        out.println("<h2> Tipo de archivo " + contentType + " no permitido</h2>");
                    }
                    part.delete();
                } catch(IOException e) {
                    out.println("<br>Error al subir el archivo " + name + " : " + e);
                }
            }
